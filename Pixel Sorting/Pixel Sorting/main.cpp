...
int main() {
    ...
    BitmapImage image1;
    if (!image1.load("C:\\Users\\diego\\Documents\\repos\\image-stuff\\Pixel Sorting\\input\\woah.bmp")) 
    {
    ...
    BitmapImage image2;
    if (!image2.load("C:\\Users\\diego\\Documents\\repos\\image-stuff\\Pixel Sorting\\input\\poop.bmp")) 
    {
    ...
    image.save("PUT OUTPUT PATH AND NAME HERE2.bmp");
}
